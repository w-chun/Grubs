...
business1 = Business.create(name: "Benu", address: "22 Hawthone St", city: "San Francisco", state: "CA",
  ...
  img_url: "http://res.cloudinary.com/dih798zsl/image/upload/v1511479405/benu_lvifbp.jpg")
business2 = Business.create(name: "KUSAKABE", address: "584 Washington St", city: "San Francisco", state: "CA",
  ...
  img_url: "http://res.cloudinary.com/dih798zsl/image/upload/v1511558624/kusakabe_fernzd.jpg")
business3 = Business.create(name: "Homeroom", address: "400 40th St", city: "Oakland", state: "CA",
  ...
  img_url: "http://res.cloudinary.com/dih798zsl/image/upload/v1511589283/homeroom_mnzwsp.jpg")
business4 = Business.create(name: "Bun Bo Hue An Nam", address: "740 Story Rd", city: "San Jose", state: "CA",
  ...
  img_url: "http://res.cloudinary.com/dih798zsl/image/upload/v1511588999/BBH_gduven.jpg")
business5 = Business.create(name: "Little Lucca Specialty Sandwich Shop", address: "724 El Camino Real", city: "South San Francisco", state: "CA",
  ...
  img_url: "http://res.cloudinary.com/dih798zsl/image/upload/v1511588575/little_lucca_ntwrcc.jpg")
business6 = Business.create(name: "Shandong Restaurant", address: "328 10th St", city: "Oakland", state: "CA",
  ...
  img_url: "http://res.cloudinary.com/dih798zsl/image/upload/v1512111784/shan-1_pqplxr.jpg")
business7 = Business.create(name: "The Boiling Crab", address: "1631 E Capitol Expy", city: "San Jose", state: "CA",
  ...
  img_url: "http://res.cloudinary.com/dih798zsl/image/upload/v1511589992/boiling_crab_jguxpj.jpg")
business8 = Business.create(name: "Yummy Yummy", address: "1015 Irving St", city: "San Francisco", state: "CA",
  ...
  img_url: "http://res.cloudinary.com/dih798zsl/image/upload/v1511590566/Yummy_iqo9gb.jpg")
business9 = Business.create(name: "Ben Tre Vietnamese Homestyle Cuisine", address: "398 Grand Ave", city: "South San Francisco", state: "CA",
  ...
  img_url: "http://res.cloudinary.com/dih798zsl/image/upload/v1511591578/bentre_ra6qux.jpg")
business10 = Business.create(name: "Hog Island Oyster Co", address: "1 Ferry Bldg", city: "San Francisco", state: "CA",
  ...
  img_url: "http://res.cloudinary.com/dih798zsl/image/upload/v1511591557/hogisland_wg9wxr.jpg")
...
image7 = Image.create(img_url:'http://res.cloudinary.com/dih798zsl/image/upload/v1512111305/homeroom_f4ot9w.jpg', business_id: business3.id)
image8 = Image.create(img_url:'http://res.cloudinary.com/dih798zsl/image/upload/v1512111304/homeroom-3_chb6yr.jpg', business_id: business3.id)
image9 = Image.create(img_url:'http://res.cloudinary.com/dih798zsl/image/upload/v1512111304/homeroom-2_wvrmju.jpg', business_id: business3.id)
...
image13 = Image.create(img_url:'http://res.cloudinary.com/dih798zsl/image/upload/v1512111305/little-3_tj0dwz.jpg', business_id: business5.id)
image14 = Image.create(img_url:'http://res.cloudinary.com/dih798zsl/image/upload/v1512111314/little-1_ohnui1.jpg', business_id: business5.id)
image15 = Image.create(img_url:'http://res.cloudinary.com/dih798zsl/image/upload/v1512111314/little-2_jlnfye.jpg', business_id: business5.id)
